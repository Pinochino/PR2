...
public class Rectangle extends Shape2D {
    ...
    Rectangle(double length, double width, Colors color, boolean filled){
        // this constructor must not assign a Point2D object to the position attribute
       this(length, width);
       setFilled(filled);
       setColors(color);
    }
    ...
    public String toString(){
        return "Rectangle[length=  " + length + " ,width= " + width + " ,and perimeter is " + getPerimeter() + " ,and area is " + getArea();
    }
